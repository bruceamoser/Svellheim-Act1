# Svellheim-Act1 — Copilot Instructions

Story beat data for **Act 1** of the Svellheim campaign (Beats 1–9).
...
## Conventions
- File naming: `beat-{NN}-{slug}.json` (e.g., `beat-07-reluctant-hearth.json`)
